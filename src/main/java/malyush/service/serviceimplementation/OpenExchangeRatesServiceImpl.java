package malyush.service.serviceimplementation;

import malyush.client.OpenExchangeRatesClient;
import malyush.model.ExchangeRates;
import malyush.service.serviceinterface.ExchangeRatesService;
...
public class OpenExchangeRatesServiceImpl implements ExchangeRatesService {
     ...
     * т.к. при запросе к openexchangerates.org//historical/* с указанием
     * вчерашней даты могут вернуться курсы с датой, равной текущей.
     * @param time
     */
