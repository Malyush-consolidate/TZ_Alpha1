...
import malyush.client.FeignOpenExchangeRatesClient;
...
public class OpenExchangeRatesServiceImplTest {
     ...
     * База приложения имеет значения 72.108
     * и 72.945(в последнем тесте, где значение базы для currentRates меняется)
